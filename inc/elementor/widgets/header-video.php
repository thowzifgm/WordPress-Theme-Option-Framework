...
class Header_Video_Widget extends Widget_Base {
  ...
  protected function register_controls() {
    $this->start_controls_section( 'header_video_section', [
      'label' => esc_html__( 'Header Video', 'themezinho' ),
    ...
    $this->add_control(
      'video_file',
      array(
        'label' => __( 'Video File', 'themezinho' ),
        'type' => Controls_Manager::TEXT,
        'description' => 'Please type url of mp4 video',
...
<section class="slider">
  <div class="video-bg">
    <video src="<?php echo esc_html( $settings['video_file'], array() ); ?>" loop muted autoplay playsinline></video>
  </div>
  <!-- end video -->
